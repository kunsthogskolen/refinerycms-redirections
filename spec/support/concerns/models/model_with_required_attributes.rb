shared_examples_for "model with required attributes" do |model_name, required_attribute_names|
  context "validations" do
    # we go through the required attributes and for each one
    # we create a context where it's set to nil and we check the object
    # is not valid and there's an error on the attributes
